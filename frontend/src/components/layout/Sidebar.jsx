...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-white/70 dark:bg-surface-secondary/30 backdrop-blur-2xl border-r border-gray-200/50 dark:border-white/10 flex flex-col transition-colors duration-300 z-20 shadow-sm relative flex-shrink-0">
