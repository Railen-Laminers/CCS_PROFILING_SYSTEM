      ...
      <span
        ...
        className={cn(
          "inline-flex items-center px-3 py-1 text-xs font-medium rounded-lg shadow-sm w-fit",
           {
            "bg-zinc-100 text-zinc-600 border border-zinc-200 dark:bg-zinc-500/10 dark:text-zinc-400 dark:border-zinc-500/20": variant === "gray",
            ...
            "bg-emerald-500 text-white border border-emerald-500": variant === "green",
