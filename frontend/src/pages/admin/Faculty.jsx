    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Faculty</h1>
                <button
                    onClick={() => {
                        resetForm();
                        setShowForm(true);
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={formMode === 'create' ? handleCreate : handleUpdate} className="p-4">
                            ...
                            <div className="flex justify-end gap-2 mt-6">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 bg-brand-500 text-white rounded-md hover:bg-brand-600 flex items-center gap-2 disabled:opacity-50"
                                    disabled={isCreating || isUpdating}
                                >
            ...
            {loading ? (
                ...
                <div className="text-center py-8 text-gray-500 dark:text-gray-400">No faculty found.</div>
            ) : (
                <div className="overflow-x-auto">
                    <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            {faculty.map((member) => (
                                <tr key={member.id} className="dark:bg-gray-800 dark:hover:bg-gray-700">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap dark:text-gray-200">{member.user_id}</td>
                                    <td className="px-6 py-4 whitespace-nowrap dark:text-gray-200">{member.email}</td>
